...
public class Const {
	...
	public static final String XMPP_HOST = "10.108.136.59";
	 ...
	 *好友在线状态更新广播
	 */
	public static final String ACTION_NEW_MSG= "com.im.newmsg";
	/**
	 *好友在线状态更新广播
	 */
	...
	public static final String MSG_TYPE_CHAT = "chat";   //统一表示消息

	public static final String MSG_SUBTYPE_TEXT = "text";
